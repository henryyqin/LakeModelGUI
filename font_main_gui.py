...
from tkinter import font            # python 3
import os
...
"""
TITLE_FONT = ("DengXian", 60)
LARGE_FONT = ("DengXian", 26)
MED_FONT = ("DengXian", 18)
f = ("DengXian", 12)
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="PRYSMv2.0: Lake PSM", font= TITLE_FONT)
        ...
        authors = tk.Label(self, text="By: Henry Qin, Xueyan Mu, Vinay Tummarakota, and Sylvia Dee",
                           font=MED_FONT)
        authors.pack(pady=10, padx=10)

        website = tk.Label(self, text="Getting Started Guide", fg="blue", cursor="hand2", font=f)
        ...
        website = tk.Label(self, text="Original Paper: "PRYSM v2.0: A Proxy System Model for Lacustrine Archives" ", fg="blue", cursor="hand2", font=f)
        website.pack(pady=10, padx=10)
        website.bind("<Button-1>", lambda e: callback(
            "https://docs.google.com/document/d/1RHYEXm5AjXO3NppNxDLPmPnHPr8tQIaT_jH7F7pU2ic/edit?usp=sharing"))
        ...
        github = tk.Label(self, text="Github", fg="blue", cursor="hand2", font=f)
