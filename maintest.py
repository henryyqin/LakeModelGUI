...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, PageOne, PageGDGT):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button2 = tk.Button(self, text="Run GDGT Model", font=f, command=lambda: controller.show_frame("PageGDGT"))
...
class PageGDGT(tk.Frame):
    ...
    def generate_graph(self):
        ...
        #CUT NUM OF DAYS AS TEMPORARY FIX
        self.days = self.days[106:]
